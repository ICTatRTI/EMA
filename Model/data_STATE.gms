...
parameters
        ...
        emis_factor(r,u,p)      pollutant emissions factors (CO2 SO2 NOx Hg) /* constant by fuel type--unmodified */ /* XXX */
        ...
        loadpct(r,l)            percentage of demand by load segment /* unmodified */ /* XXX */
        dadj(r,t)               demand adjustment to turn demand into NEL (including CHP and trade) /* unmodified */ /* XXX */
        hours(r,l)              hours per load segment /* constant */ /* XXX */
        maxCF(r,u,l)            maximum capacity factor /* unmodified */ /* XXX */
        /*peak(r,t)*/               peak demand /* unmodified */
        /*rsrv_factor(r,u)*/        reserve margin contribution factor for wind-solar /* unmodified */
        transmit_limit(r,rr)    transmission limits /* unmodified */ /* XXX */

        pbio(r,biostep,t)       price of biomass by step function /* unmodified */ /* XXX */
        biosupply(r,biostep,t)  supply of biomass by step function /* unmodified */ /* XXX */
;
...
$gdxin '..\Data\output\MEEDE_capacity_STATE.gdx'
$loaddc capacity

$gdxin '..\Data\output\MEEDE_fomcost_STATE.gdx'
$loaddc fomcost

$gdxin '..\Data\output\MEEDE_vomcost_STATE.gdx'
$loaddc vomcost

$gdxin '..\Data\output\MEEDE_heatrate_STATE.gdx'
$loaddc heatrate

$gdxin '..\Data\output\MEEDE_dele_STATE.gdx'
$loaddc dele

$gdxin '..\Data\output\MEEDE_pf_STATE.gdx'
$loaddc pf

* Load in remaining data unmodified
$gdxin '..\Data\output\biosupply_2020_STATE.gdx'
$loaddc biosupply

$gdxin '..\Data\output\dadj_2020_STATE.gdx'
$loaddc dadj

$gdxin '..\Data\output\pbio_2020_STATE.gdx'
$loaddc pbio

$gdxin '..\Data\output\maxCF_STATE.gdx'
$loaddc maxCF

$gdxin '..\Data\output\hours_STATE.gdx'
$loaddc hours

$gdxin '..\Data\output\transmit_limit_STATE.gdx'
$loaddc transmit_limit

$gdxin '..\Data\output\loadpct_STATE.gdx'
$loaddc loadpct

$gdxin '..\Data\output\fueltype.gdx'
$loaddc fueltype

$gdxin '..\Data\output\emis_factor_STATE.gdx'
$loaddc emis_factor
